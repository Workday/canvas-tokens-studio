...
| Theme tokens                  |  1460 |
| Tokens tokens                 |   722 |
| Unchanged (same path + value) |   493 |
| Value changed (same path)     |   223 |
| Renamed (path changed)        |     1 |
| New (theme only)              |   743 |
| Removed (tokens only)         |     5 |
...
| `palette.white.$root` _(was `palette.neutral.0`)_ | Paper       | `#ffffff` ✓ |
...
| `base/palette.json`     |   727 |    256 |  156 |      98 |       1 | 472 |       1 |
...
| `sys/breakpoint.json`   |     6 |      5 |    5 |       0 |       0 |   1 |       0 |
| `sys/color/light.json`  |   157 |    105 |   34 |      71 |       0 |  52 |       0 |
...
**Fully unchanged files:** `base/base.json`, `base/motion.json`, `base/opacity.json`,
`sys/motion.json`, `sys/opacity.json`, `sys/size.json`, `sys/space.json`
...
Most differences are alpha steps (e.g. `palette.*.A25`) where theme intentionally diverges. **141**
overlapping OKLCH tokens were restored to tokens values where colors were very similar (|ΔL| ≤
0.001, |ΔC| ≤ 0.0015, |ΔH| ≤ 0.25°, or same hex).
...
Primary pattern: `brand.neutral.*` references changed from `{palette.slate.*}` to
`{palette.neutral.*}`; action colors move off blue to the neutral scale.
...
### `sys/color/light.json` (71)

**Patterns:**

- `slate` → `brand.neutral` (17 tokens)
- `neutral.0` → `white.$root` for surfaces (8 tokens)
- `palette.*` / `brand.*` routing for `color.brand.*` tokens (10 tokens)
- `black` / `slate` for shadows and overlay
...
| `color.bg.alt.default`                  | `{brand.neutral.50}`    | `{palette.slate.50}`     |
| `color.surface.default`                 | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.surface.inverse`                 | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.surface.raised`                  | `{brand.neutral.A25}`   | `{palette.slate.A25}`    |
| `color.surface.overlay.hover.default`   | `{brand.neutral.A50}`   | `{palette.slate.A50}`    |
| `color.surface.overlay.pressed.default` | `{brand.neutral.A100}`  | `{palette.slate.A100}`   |
| `color.surface.overlay.scrim`           | `{brand.neutral.A400}`  | `{palette.neutral.A400}` |
| `color.surface.overlay.mixin`           | `{palette.black.$root}` | `{palette.slate.500}`    |
| `color.surface.alt.default`             | `{brand.neutral.A50}`   | `{palette.slate.A50}`    |
| `color.surface.alt.strong`              | `{brand.neutral.A100}`  | `{palette.slate.A100}`   |
| `color.surface.contrast.default`        | `{brand.neutral.A900}`  | `{palette.neutral.A900}` |
| `color.surface.contrast.strong`         | `{brand.neutral.A950}`  | `{palette.neutral.A950}` |
| `color.surface.danger.default`          | `{brand.critical.A25}`  | `{palette.red.A25}`      |
| `color.surface.danger.strong`           | `{brand.critical.A50}`  | `{palette.red.A50}`      |
| `color.surface.success.default`         | `{brand.positive.A25}`  | `{palette.green.A25}`    |
| `color.surface.success.strong`          | `{brand.positive.A50}`  | `{palette.green.A50}`    |
| `color.surface.warning.default`         | `{brand.caution.A25}`   | `{palette.amber.A25}`    |
| `color.surface.warning.strong`          | `{brand.caution.A50}`   | `{palette.amber.A50}`    |
| `color.surface.loading`                 | `{brand.neutral.A50}`   | `{palette.slate.A200}`   |
| `color.surface.modal`                   | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.surface.navigation`              | `{brand.neutral.50}`    | `{palette.slate.50}`     |
| `color.surface.popover`                 | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.surface.transparent`             | `{palette.white.A0}`    | `{palette.neutral.A0}`   |
| `color.accent.muted.default`            | `{brand.neutral.600}`   | `{palette.slate.600}`    |
| `color.accent.muted.soft`               | `{brand.neutral.400}`   | `{palette.slate.400}`    |
...
| `color.accent.overlay.mixin`            | `{palette.black.$root}` | `{palette.neutral.1000}` |
| `color.accent.danger`                   | `{brand.critical.600}`  | `{palette.red.600}`      |
| `color.accent.success`                  | `{brand.positive.600}`  | `{palette.green.600}`    |
| `color.accent.warning`                  | `{brand.caution.400}`   | `{palette.amber.400}`    |
| `color.accent.contrast`                 | `{brand.neutral.A900}`  | `{palette.neutral.A900}` |
| `color.fg.default`                      | `{brand.neutral.A800}`  | `{palette.neutral.A800}` |
| `color.fg.strong`                       | `{brand.neutral.A900}`  | `{palette.neutral.A900}` |
| `color.fg.stronger`                     | `{brand.neutral.A950}`  | `{palette.neutral.A950}` |
| `color.fg.muted.default`                | `{brand.neutral.A600}`  | `{palette.slate.A600}`   |
| `color.fg.muted.strong`                 | `{brand.neutral.A700}`  | `{palette.slate.A700}`   |
| `color.fg.disabled`                     | `{brand.neutral.A400}`  | `{palette.slate.A400}`   |
| `color.fg.danger.default`               | `{brand.critical.600}`  | `{palette.red.600}`      |
| `color.fg.danger.strong`                | `{brand.critical.700}`  | `{palette.red.700}`      |
| `color.fg.warning.default`              | `{brand.caution.600}`   | `{palette.amber.600}`    |
| `color.fg.warning.strong`               | `{brand.caution.700}`   | `{palette.amber.700}`    |
| `color.fg.success.default`              | `{brand.positive.600}`  | `{palette.green.600}`    |
| `color.fg.success.strong`               | `{brand.positive.700}`  | `{palette.green.700}`    |
| `color.fg.contrast.default`             | `{palette.black.A900}`  | `{palette.neutral.A900}` |
| `color.fg.contrast.strong`              | `{palette.black.A950}`  | `{palette.neutral.A950}` |
| `color.fg.inverse`                      | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.border.default`                  | `{brand.neutral.A100}`  | `{palette.slate.A200}`   |
| `color.border.strong`                   | `{brand.neutral.A200}`  | `{palette.slate.A300}`   |
| `color.border.inverse.default`          | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.border.input.default`            | `{brand.neutral.A500}`  | `{palette.slate.A500}`   |
| `color.border.input.hover`              | `{brand.neutral.A700}`  | `{palette.slate.A700}`   |
| `color.border.contrast.default`         | `{palette.black.A900}`  | `{palette.neutral.A900}` |
| `color.border.danger`                   | `{brand.critical.500}`  | `{palette.red.500}`      |
| `color.border.warning`                  | `{brand.caution.500}`   | `{palette.amber.400}`    |
| `color.border.transparent`              | `{palette.white.A0}`    | `{palette.neutral.A0}`   |
| `color.focus.inverse`                   | `{palette.white.$root}` | `{palette.neutral.0}`    |
| `color.focus.contrast`                  | `{brand.neutral.A900}`  | `{palette.neutral.A900}` |
...
| `color.brand.surface.primary.default`   | `{brand.neutral.A25}`   | `{brand.primary.A25}`    |
| `color.brand.surface.primary.strong`    | `{brand.neutral.A50}`   | `{brand.primary.A50}`    |
| `color.brand.surface.selected`          | `{brand.neutral.A100}`  | `{brand.primary.A50}`    |
| `color.brand.accent.primary`            | `{brand.neutral.975}`   | `{brand.primary.600}`    |
| `color.brand.accent.action`             | `{brand.neutral.975}`   | `{brand.primary.600}`    |
| `color.brand.border.primary`            | `{palette.blue.500}`    | `{brand.primary.500}`    |
| `color.brand.fg.primary.default`        | `{brand.neutral.A900}`  | `{brand.primary.600}`    |
| `color.brand.fg.primary.strong`         | `{brand.neutral.A950}`  | `{brand.primary.700}`    |
| `color.brand.fg.selected`               | `{brand.neutral.A900}`  | `{brand.primary.700}`    |
...
| Path      | Theme                                                   | Tokens                                                  |
| --------- | ------------------------------------------------------- | ------------------------------------------------------- |
| `depth.1` | `[{"x":"0","y":"{shadow.1.100.y}","blur":"{shadow.1.1…` | `[{"x":"0","y":"{shadow.1.100.y}","blur":"{shadow.1.1…` |
| `depth.2` | `[{"x":"0","y":"{shadow.2.100.y}","blur":"{shadow.2.1…` | `[{"x":"0","y":"{shadow.2.100.y}","blur":"{shadow.2.1…` |
| `depth.3` | `[{"x":"0","y":"{shadow.3.100.y}","blur":"{shadow.3.1…` | `[{"x":"0","y":"{shadow.3.100.y}","blur":"{shadow.3.1…` |
| `depth.4` | `[{"x":"0","y":"{shadow.4.100.y}","blur":"{shadow.4.1…` | `[{"x":"0","y":"{shadow.4.100.y}","blur":"{shadow.4.1…` |
| `depth.5` | `[{"x":"0","y":"{shadow.5.100.y}","blur":"{shadow.5.1…` | `[{"x":"0","y":"{shadow.5.100.y}","blur":"{shadow.5.1…` |
| `depth.6` | `[{"x":"0","y":"{shadow.6.100.y}","blur":"{shadow.6.1…` | `[{"x":"0","y":"{shadow.6.100.y}","blur":"{shadow.6.1…` |
...
| `letter-spacing.subtext.sm` | `0.13`       | `{letter-spacing.50}`  |
| `letter-spacing.subtext.md` | `0.12`       | `{letter-spacing.100}` |
| `letter-spacing.subtext.lg` | `0.11`       | `{letter-spacing.150}` |
| `letter-spacing.body.sm`    | `0.1`        | `{letter-spacing.200}` |
...
| File                | From (tokens)          | To (theme)            | Match      |
| ------------------- | ---------------------- | --------------------- | ---------- |
| `base/palette.json` | `palette.neutral.1000` | `palette.black.$root` | same value |
...
| `base/palette.json`     |   156 |
| `base/shadow.json`      |    24 |
| `base/size.json`        |    25 |
| `base/typography.json`  |     1 |
| `sys/brand/canvas.json` |    73 |
| `sys/breakpoint.json`   |     5 |
| `sys/color/light.json`  |    34 |
| `sys/motion.json`       |     6 |
| `sys/opacity.json`      |    12 |
| `sys/shape.json`        |     5 |
| `sys/size.json`         |     8 |
...
| `sys/breakpoint.json`   | `breakpoints.md`                                     | `{base.baseline} * 96`                                                       |
...
| `sys/color/light.json`  | `color.brand.focus.caution.inner`                    | `{brand.caution.400}`                                                        |
| `sys/color/light.json`  | `color.brand.focus.caution.outer`                    | `{brand.caution.500}`                                                        |
| `sys/color/light.json`  | `color.brand.focus.critical`                         | `{brand.critical.500}`                                                       |
| `sys/color/light.json`  | `color.brand.surface.caution.default`                | `{brand.caution.A25}`                                                        |
| `sys/color/light.json`  | `color.brand.surface.caution.strong`                 | `{brand.caution.A50}`                                                        |
| `sys/color/light.json`  | `color.brand.surface.critical.default`               | `{brand.critical.A25}`                                                       |
| `sys/color/light.json`  | `color.brand.surface.critical.strong`                | `{brand.critical.A50}`                                                       |
| `sys/color/light.json`  | `color.brand.surface.positive.default`               | `{brand.positive.A25}`                                                       |
| `sys/color/light.json`  | `color.brand.surface.positive.strong`                | `{brand.positive.A50}`                                                       |
| `sys/color/light.json`  | `color.brand.accent.caution`                         | `{brand.caution.400}`                                                        |
| `sys/color/light.json`  | `color.brand.accent.critical`                        | `{brand.critical.600}`                                                       |
| `sys/color/light.json`  | `color.brand.accent.positive`                        | `{brand.positive.600}`                                                       |
| `sys/color/light.json`  | `color.brand.border.caution`                         | `{brand.caution.500}`                                                        |
| `sys/color/light.json`  | `color.brand.border.critical`                        | `{brand.critical.500}`                                                       |
| `sys/color/light.json`  | `color.brand.fg.critical.default`                    | `{brand.critical.600}`                                                       |
| `sys/color/light.json`  | `color.brand.fg.critical.strong`                     | `{brand.critical.700}`                                                       |
| `sys/color/light.json`  | `color.brand.fg.caution.default`                     | `{brand.caution.600}`                                                        |
| `sys/color/light.json`  | `color.brand.fg.caution.strong`                      | `{brand.caution.700}`                                                        |
| `sys/color/light.json`  | `color.brand.fg.positive.default`                    | `{brand.positive.600}`                                                       |
...
| `sys/type.json`         | `type.subtext.sm`                                    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.subtext.md`                                    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.subtext.lg`                                    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.body.sm`                                       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.body.md`                                       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.body.lg`                                       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.heading.sm`                                    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.heading.md`                                    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.heading.lg`                                    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.title.sm`                                      | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.title.md`                                      | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `type.title.lg`                                      | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S - (500) Medium`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S - (700) Bold`         | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S Link - (400) Regular` | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S Link - (500) Medium`  | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S Link - (700) Bold`    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S Mono - (400) Regular` | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S Mono - (500) Medium`  | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext S Mono - (700) Bold`    | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M - (500) Medium`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M - (700) Bold`         | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M Link - (400) Regular` | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M Link - (500) Medium`  | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M Link - (700) Bold`    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M Mono - (400) Regular` | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M Mono - (500) Medium`  | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext M Mono - (700) Bold`    | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L - (500) Medium`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L - (700) Bold`         | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L Link - (400) Regular` | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L Link - (500) Medium`  | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L Link - (700) Bold`    | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L Mono - (400) Regular` | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L Mono - (500) Medium`  | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Subtext.Subtext L Mono - (700) Bold`    | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Body.Body S - (500) Medium`             | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body S - (700) Bold`               | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body S Link - (400) Regular`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body S Link - (500) Medium`        | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body S Link - (700) Bold`          | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body S Mono - (400) Regular`       | `{"fontFamily":"{font-family.mono}","fontWeight":"{fo…`                      |
| `sys/type.json`         | `More styles.Body.Body M - (500) Medium`             | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body M - (700) Bold`               | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body M Link - (400) Regular`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body M Link - (500) Medium`        | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body M Link - (700) Bold`          | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body L - (500) Medium`             | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body L - (700) Bold`               | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body L Link - (400) Regular`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body L Link - (500) Medium`        | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Body.Body L Link - (700) Bold`          | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Heading.Heading S - (500) Medium`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Heading.Heading M - (500) Medium`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Heading.Heading L - (500) Medium`       | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Title.Title S - (300) Light`            | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Title.Title S - (500) Medium`           | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Title.Title M - (300) Light`            | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Title.Title M - (500) Medium`           | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Title.Title L - (300) Light`            | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
| `sys/type.json`         | `More styles.Title.Title L - (500) Medium`           | `{"fontFamily":"{font-family.default}","fontWeight":"…`                      |
...
| `color.chart.categorical.6`            | `{brand.positive.600}`  |
| `color.chart.categorical.7`            | `{palette.purple.500}`  |
| `color.chart.categorical.8`            | `{brand.caution.500}`   |
...
| `color.chart.categorical.15`           | `{brand.positive.800}`  |
| `color.chart.categorical.16`           | `{brand.caution.700}`   |
...
| `letter-spacing.body.lg`    | `-0.1`                                                                                                                                                                                  |
| `letter-spacing.heading.sm` | `-0.3`                                                                                                                                                                                  |
| `letter-spacing.heading.md` | `-0.34`                                                                                                                                                                                 |
| `letter-spacing.heading.lg` | `-0.38`                                                                                                                                                                                 |
| `letter-spacing.title.sm`   | `-0.46`                                                                                                                                                                                 |
| `letter-spacing.title.md`   | `-0.54`                                                                                                                                                                                 |
| `letter-spacing.title.lg`   | `-0.62`                                                                                                                                                                                 |
...
1. **Palette expansion** — `dark.palette.*`, `palette.white.*` / `palette.black.*`, extended hue
   steps; `palette.neutral.0` / `1000` replaced by `$root` tokens
2. **Brand routing** — `sys/color/light.json` semantic colors use
   `brand.{neutral,critical,positive,caution}.*` instead of raw palette refs
3. **Typography overhaul** — Sana Sans + IBM Plex Mono; numeric font weights; letter-spacing rescale
   (`50/100/150/200` → `5–12`)
4. **Color restructure** — chart tokens, brand namespace under `color.brand.*`, palette family swaps
   (slate ↔ neutral); primary accent → `brand.neutral.975`
5. **Shape scale** — new `shape.xs`; adjusted sm/xxl/xxxl size references
6. **Stable foundations** — motion, opacity, space, sys size unchanged
