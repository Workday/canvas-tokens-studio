...
| Theme tokens                  |  1613 |
| Tokens tokens                 |   722 |
| Unchanged (same path + value) |   499 |
| Value changed (same path)     |   218 |
...
| `base/typography.json`  |    20 |     11 |    1 |      10 |       0 |   9 |       0 |
| `sys/brand/canvas.json` |   289 |    107 |   73 |      34 |       0 | 182 |       0 |
| `sys/breakpoint.json`   |     6 |      5 |    4 |       1 |       0 |   1 |       0 |
| `sys/color/light.json`  |   152 |    105 |   39 |      61 |       0 |  52 |       5 |
...
### `base/typography.json` (10)

| Path                 | Theme                 | Tokens        |
| -------------------- | --------------------- | ------------- |
| `font-family.50`     | `Sana Sans LCG 05 VF` | `Roboto`      |
| `font-family.100`    | `IBM Plex Mono`       | `Roboto Mono` |
| `letter-spacing.50`  | `0.13`                | `0.4`         |
| `letter-spacing.100` | `0.12`                | `0.32`        |
| `letter-spacing.150` | `0.11`                | `0.24`        |
| `letter-spacing.200` | `0.1`                 | `0.16`        |
...
| Group                 | Count |
| --------------------- | ----: |
| `brand.dark.neutral`  |    30 |
| `brand.dark.caution`  |    26 |
| `brand.dark.critical` |    26 |
| `brand.dark.positive` |    26 |
| `brand.dark.primary`  |    26 |
| `brand.dark.action`   |     8 |
...
| `brand.dark.action.accent`   | `{palette.black.$root}`       |
| `brand.dark.action.base`     | `{brand.dark.neutral.975}`    |
| `brand.dark.action.dark`     | `{brand.dark.neutral.975}`    |
| `brand.dark.action.darker`   | `{brand.dark.neutral.975}`    |
| `brand.dark.action.darkest`  | `{brand.dark.neutral.950}`    |
| `brand.dark.action.light`    | `{brand.dark.neutral.200}`    |
| `brand.dark.action.lighter`  | `{brand.dark.neutral.100}`    |
| `brand.dark.action.lightest` | `{brand.dark.neutral.25}`     |
| `brand.dark.caution.25`      | `{dark.palette.amber.25}`     |
| `brand.dark.caution.50`      | `{dark.palette.amber.50}`     |
| `brand.dark.caution.100`     | `{dark.palette.amber.100}`    |
| `brand.dark.caution.200`     | `{dark.palette.amber.200}`    |
| `brand.dark.caution.300`     | `{dark.palette.amber.300}`    |
| `brand.dark.caution.400`     | `{dark.palette.amber.400}`    |
| `brand.dark.caution.500`     | `{dark.palette.amber.500}`    |
| `brand.dark.caution.600`     | `{dark.palette.amber.600}`    |
| `brand.dark.caution.700`     | `{dark.palette.amber.700}`    |
| `brand.dark.caution.800`     | `{dark.palette.amber.800}`    |
| `brand.dark.caution.900`     | `{dark.palette.amber.900}`    |
| `brand.dark.caution.950`     | `{dark.palette.amber.950}`    |
| `brand.dark.caution.975`     | `{dark.palette.amber.975}`    |
| `brand.dark.caution.A25`     | `{dark.palette.amber.A25}`    |
| `brand.dark.caution.A50`     | `{dark.palette.amber.A50}`    |
| `brand.dark.caution.A100`    | `{dark.palette.amber.A100}`   |
| `brand.dark.caution.A200`    | `{dark.palette.amber.A200}`   |
| `brand.dark.caution.A300`    | `{dark.palette.amber.A300}`   |
| `brand.dark.caution.A400`    | `{dark.palette.amber.A400}`   |
| `brand.dark.caution.A500`    | `{dark.palette.amber.A500}`   |
| `brand.dark.caution.A600`    | `{dark.palette.amber.A600}`   |
| `brand.dark.caution.A700`    | `{dark.palette.amber.A700}`   |
| `brand.dark.caution.A800`    | `{dark.palette.amber.A800}`   |
| `brand.dark.caution.A900`    | `{dark.palette.amber.A900}`   |
| `brand.dark.caution.A950`    | `{dark.palette.amber.A950}`   |
| `brand.dark.caution.A975`    | `{dark.palette.amber.A975}`   |
| `brand.dark.critical.25`     | `{dark.palette.red.25}`       |
| `brand.dark.critical.50`     | `{dark.palette.red.50}`       |
| `brand.dark.critical.100`    | `{dark.palette.red.100}`      |
| `brand.dark.critical.200`    | `{dark.palette.red.200}`      |
| `brand.dark.critical.300`    | `{dark.palette.red.300}`      |
| `brand.dark.critical.400`    | `{dark.palette.red.400}`      |
| `brand.dark.critical.500`    | `{dark.palette.red.500}`      |
| `brand.dark.critical.600`    | `{dark.palette.red.600}`      |
| `brand.dark.critical.700`    | `{dark.palette.red.700}`      |
| `brand.dark.critical.800`    | `{dark.palette.red.800}`      |
| `brand.dark.critical.900`    | `{dark.palette.red.900}`      |
| `brand.dark.critical.950`    | `{dark.palette.red.950}`      |
| `brand.dark.critical.975`    | `{dark.palette.red.975}`      |
| `brand.dark.critical.A25`    | `{dark.palette.red.A25}`      |
| `brand.dark.critical.A50`    | `{dark.palette.red.A50}`      |
| `brand.dark.critical.A100`   | `{dark.palette.red.A100}`     |
| `brand.dark.critical.A200`   | `{dark.palette.red.A200}`     |
| `brand.dark.critical.A300`   | `{dark.palette.red.A300}`     |
| `brand.dark.critical.A400`   | `{dark.palette.red.A400}`     |
| `brand.dark.critical.A500`   | `{dark.palette.red.A500}`     |
| `brand.dark.critical.A600`   | `{dark.palette.red.A600}`     |
| `brand.dark.critical.A700`   | `{dark.palette.red.A700}`     |
| `brand.dark.critical.A800`   | `{dark.palette.red.A800}`     |
| `brand.dark.critical.A900`   | `{dark.palette.red.A900}`     |
| `brand.dark.critical.A950`   | `{dark.palette.red.A950}`     |
| `brand.dark.critical.A975`   | `{dark.palette.red.A975}`     |
| `brand.dark.neutral.25`      | `{dark.palette.neutral.25}`   |
| `brand.dark.neutral.50`      | `{dark.palette.neutral.50}`   |
| `brand.dark.neutral.100`     | `{dark.palette.neutral.100}`  |
| `brand.dark.neutral.150`     | `{dark.palette.neutral.150}`  |
| `brand.dark.neutral.200`     | `{dark.palette.neutral.200}`  |
| `brand.dark.neutral.300`     | `{dark.palette.neutral.300}`  |
| `brand.dark.neutral.400`     | `{dark.palette.neutral.400}`  |
| `brand.dark.neutral.500`     | `{dark.palette.neutral.500}`  |
| `brand.dark.neutral.600`     | `{dark.palette.neutral.600}`  |
| `brand.dark.neutral.700`     | `{dark.palette.neutral.700}`  |
| `brand.dark.neutral.800`     | `{dark.palette.neutral.800}`  |
| `brand.dark.neutral.850`     | `{dark.palette.neutral.850}`  |
| `brand.dark.neutral.900`     | `{dark.palette.neutral.900}`  |
| `brand.dark.neutral.950`     | `{dark.palette.neutral.950}`  |
| `brand.dark.neutral.975`     | `{dark.palette.neutral.975}`  |
| `brand.dark.neutral.A25`     | `{dark.palette.neutral.A25}`  |
| `brand.dark.neutral.A50`     | `{dark.palette.neutral.A50}`  |
| `brand.dark.neutral.A100`    | `{dark.palette.neutral.A100}` |
| `brand.dark.neutral.A150`    | `{dark.palette.neutral.A150}` |
| `brand.dark.neutral.A200`    | `{dark.palette.neutral.A200}` |
| `brand.dark.neutral.A300`    | `{dark.palette.neutral.A300}` |
| `brand.dark.neutral.A400`    | `{dark.palette.neutral.A400}` |
| `brand.dark.neutral.A500`    | `{dark.palette.neutral.A500}` |
| `brand.dark.neutral.A600`    | `{dark.palette.neutral.A600}` |
| `brand.dark.neutral.A700`    | `{dark.palette.neutral.A700}` |
| `brand.dark.neutral.A800`    | `{dark.palette.neutral.A800}` |
| `brand.dark.neutral.A850`    | `{dark.palette.neutral.A850}` |
| `brand.dark.neutral.A900`    | `{dark.palette.neutral.A900}` |
| `brand.dark.neutral.A950`    | `{dark.palette.neutral.A950}` |
| `brand.dark.neutral.A975`    | `{dark.palette.neutral.A975}` |
| `brand.dark.positive.25`     | `{dark.palette.green.25}`     |
| `brand.dark.positive.50`     | `{dark.palette.green.50}`     |
| `brand.dark.positive.100`    | `{dark.palette.green.100}`    |
| `brand.dark.positive.200`    | `{dark.palette.green.200}`    |
| `brand.dark.positive.300`    | `{dark.palette.green.300}`    |
| `brand.dark.positive.400`    | `{dark.palette.green.400}`    |
| `brand.dark.positive.500`    | `{dark.palette.green.500}`    |
| `brand.dark.positive.600`    | `{dark.palette.green.600}`    |
| `brand.dark.positive.700`    | `{dark.palette.green.700}`    |
| `brand.dark.positive.800`    | `{dark.palette.green.800}`    |
| `brand.dark.positive.900`    | `{dark.palette.green.900}`    |
| `brand.dark.positive.950`    | `{dark.palette.green.950}`    |
| `brand.dark.positive.975`    | `{dark.palette.green.975}`    |
| `brand.dark.positive.A25`    | `{dark.palette.green.A25}`    |
| `brand.dark.positive.A50`    | `{dark.palette.green.A50}`    |
| `brand.dark.positive.A100`   | `{dark.palette.green.A100}`   |
| `brand.dark.positive.A200`   | `{dark.palette.green.A200}`   |
| `brand.dark.positive.A300`   | `{dark.palette.green.A300}`   |
| `brand.dark.positive.A400`   | `{dark.palette.green.A400}`   |
| `brand.dark.positive.A500`   | `{dark.palette.green.A500}`   |
| `brand.dark.positive.A600`   | `{dark.palette.green.A600}`   |
| `brand.dark.positive.A700`   | `{dark.palette.green.A700}`   |
| `brand.dark.positive.A800`   | `{dark.palette.green.A800}`   |
| `brand.dark.positive.A900`   | `{dark.palette.green.A900}`   |
| `brand.dark.positive.A950`   | `{dark.palette.green.A950}`   |
| `brand.dark.positive.A975`   | `{dark.palette.green.A975}`   |
| `brand.dark.primary.25`      | `{dark.palette.blue.25}`      |
| `brand.dark.primary.50`      | `{dark.palette.blue.50}`      |
| `brand.dark.primary.100`     | `{dark.palette.blue.100}`     |
| `brand.dark.primary.200`     | `{dark.palette.blue.200}`     |
| `brand.dark.primary.300`     | `{dark.palette.blue.300}`     |
| `brand.dark.primary.400`     | `{dark.palette.blue.400}`     |
| `brand.dark.primary.500`     | `{dark.palette.blue.500}`     |
| `brand.dark.primary.600`     | `{dark.palette.blue.600}`     |
| `brand.dark.primary.700`     | `{dark.palette.blue.700}`     |
| `brand.dark.primary.800`     | `{dark.palette.blue.800}`     |
| `brand.dark.primary.900`     | `{dark.palette.blue.900}`     |
| `brand.dark.primary.950`     | `{dark.palette.blue.950}`     |
| `brand.dark.primary.975`     | `{dark.palette.blue.975}`     |
| `brand.dark.primary.A25`     | `{dark.palette.blue.A25}`     |
| `brand.dark.primary.A50`     | `{dark.palette.blue.A50}`     |
| `brand.dark.primary.A100`    | `{dark.palette.blue.A100}`    |
| `brand.dark.primary.A200`    | `{dark.palette.blue.A200}`    |
| `brand.dark.primary.A300`    | `{dark.palette.blue.A300}`    |
| `brand.dark.primary.A400`    | `{dark.palette.blue.A400}`    |
| `brand.dark.primary.A500`    | `{dark.palette.blue.A500}`    |
| `brand.dark.primary.A600`    | `{dark.palette.blue.A600}`    |
| `brand.dark.primary.A700`    | `{dark.palette.blue.A700}`    |
| `brand.dark.primary.A800`    | `{dark.palette.blue.A800}`    |
| `brand.dark.primary.A900`    | `{dark.palette.blue.A900}`    |
| `brand.dark.primary.A950`    | `{dark.palette.blue.A950}`    |
| `brand.dark.primary.A975`    | `{dark.palette.blue.A975}`    |
...
| File                   | Path                             | Value                    |
| ---------------------- | -------------------------------- | ------------------------ |
| `sys/color/color.json` | `color.accent.contrast`          | `{palette.neutral.A900}` |
| `sys/color/color.json` | `color.brand.fg.critical.strong` | `{brand.critical.700}`   |
| `sys/color/color.json` | `color.brand.fg.caution.strong`  | `{brand.caution.700}`    |
| `sys/color/color.json` | `color.brand.fg.positive.strong` | `{brand.positive.700}`   |
| `sys/color/color.json` | `color.border.warning`           | `{palette.amber.400}`    |

---

## Key themes

1. **Palette expansion** — dark palette (`dark.palette.*`), tenant palettes, black scale, extended
   hue steps
2. **Typography overhaul** — Sana Sans + IBM Plex Mono; numeric font weights; letter-spacing rescale
   (`50/100/150/200`)
3. **Color restructure** — chart tokens, brand namespace under `color.brand.*`, palette family swaps
   (slate ↔ neutral)
